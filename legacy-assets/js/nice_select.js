(function ( $ ) {
	...
	$.fn.niceselect = function()
	{
		...
		return this.each(function(index,value)
		{
			...
			$('body').on('click','.selectcon',function(e)
			{
				e.stopImmediatePropagation();
				if($(this).parent().hasClass('active'))
				{
					$(this).parent('.niceSelect').children('.niceselect').find('.value_wrapper').hide();
					$(this).parent('.niceSelect').removeClass('active');
				}
				else
				{
					$(this).parent('.niceSelect').children('.niceselect').children('.value_wrapper').show();
					$(this).parent('.niceSelect').addClass('active');
				}
			});
			$('body').on('click','.niceSelect',function(e)
			{
				...
				{
					$(this).children('.niceselect').find('.value_wrapper').hide();
					$(this).removeClass('active');
				}
				else
				{
					$(this).children('.niceselect').children('.value_wrapper').show();
			...
			$('body').on('click','.niceselect .value_wrapper .values',function(e){
				...
				else
				{
				 ...
				 var originalElement = checkBoxes.parent().parent().parent().next();
				 
				 checkBoxes.prop("checked", !checkBoxes.prop("checked"));
				 checkBoxes.trigger('change');

				 originalElement.val(checkBoxes.val());
