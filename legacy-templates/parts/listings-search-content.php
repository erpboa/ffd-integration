...
$time_one = time();
    ...
    $maxBaths= $default_values['maxBaths']; //FFDL_Helper::get_max("pba__bathrooms_pb__c"); 
...
<input id="ulBaths" value="<?php echo $maxBaths?>" type="hidden" />
                    ...
                    <div class="property-search">
                        <div class="proprety-selection-wrap">
                                <select id="orderby" name="orderby" class="form-control niceSelect">
                                    <option <?php echo isset($_GET["orderby"]) && $_GET["orderby"]=="listed_date:desc"?"selected":"" ?> value="listed_date:desc">Date - Newest</option>    
                                    <option <?php echo isset($_GET["orderby"]) && $_GET["orderby"]=="listed_date:asc"?"selected":"" ?> value="listed_date:asc">Date - Oldest</option>    
                                    <option <?php echo !isset($_GET["orderby"]) || ( isset($_GET["orderby"]) && $_GET["orderby"]=="days_on_market:asc") ? "selected":"" ?> value="days_on_market:asc">Market Days - Newest</option>    
                                    <option <?php echo isset($_GET["orderby"]) && $_GET["orderby"]=="days_on_market:desc"?"selected":"" ?> value="days_on_market:desc">Market Days - Oldest</option>  
                                    <option <?php echo isset($_GET["orderby"]) && $_GET["orderby"]=="listing_price:asc"?"selected":"" ?> value="listing_price:asc">Price - Low to High</option>
                                    <option <?php echo (isset($_GET["orderby"]) && $_GET["orderby"]=="listing_price:desc")?"selected":"" ?> value="listing_price:desc">Price - High to Low</option>
                                </select>
                        </div>
                        ...
                        <div class="filters-tags">
                            <span class="btn btn-info search-filter-tag keyword-tag" type="button">
                                <span class="search-filter-tag-text">123456</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            <span class="btn btn-info search-filter-tag district-tag" type="button">
                                <span class="search-filter-tag-text">Hamakua</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            <span class="btn btn-info search-filter-tag property-type-tag" type="button">
                                <span class="search-filter-tag-text">Business</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            <span class="btn btn-info search-filter-tag beds-range-tag" type="button">
                                <span class="search-filter-tag-text">0 to 12 beds</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            <span class="btn btn-info search-filter-tag baths-range-tag" type="button">
                                <span class="search-filter-tag-text">0 to 12 beds</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            <span class="btn btn-info search-filter-tag baths-tag" type="button">
                                <span class="search-filter-tag-text">5 Baths</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            <span class="btn btn-info search-filter-tag frontage-tag" type="button">
                                <span class="search-filter-tag-text"></span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                            ...
                            <span class="btn btn-info search-filter-tag price-range-tag" type="button">
                                <span class="search-filter-tag-text">$0 to $320,000</span> <span class="fa fa-times fa-close remove-filter-tag"></span>
                            </span>
                        </div>
                    </div>
